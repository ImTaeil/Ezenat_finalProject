...
<div class="container">
	<p style="font-weight: bold; font-size: 30px;">상품 등록</p>
	<table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
		<thead>
			<tr>
				<th style="border-right: none;" colspan="2">표시 설정</th>
			</tr>
		</thead>
		<tbody>
			<tr>
				...
				<td style="border-right: none;">
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"> <label class="form-check-label" for="inlineRadio1">진열함</label>
					</div>
					<div class="form-check form-check-inline">
						<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> <label class="form-check-label" for="inlineRadio2">진열안함</label>
					</div>
				</td>
			</tr>
	...
	<table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
		<thead>
			<tr>
				<th style="border-right: none;" colspan="2">기본 정보</th>
			</tr>
		</thead>
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<div class="d-flex align-items-center">
						<input type="text" class="form-control" id="" placeholder="" style="width:800px; margin-right:5px;">
						<button type="submit" class="btn btn-dark" style="border-radius: 1">중복확인</button>
					</div>
				</td>
			</tr>
			...
			<tr>
				...
				<td><textarea placeholder="문구 입력..." class="border-0" rows="3" style="width: 100%;" name="content" id="content"></textarea></td>
			</tr>

			<tr>
				<td class="table-light">상품 상세설명</td>
				<td><textarea placeholder="문구 입력..." class="border-0" rows="9" style="width: 100%;" name="content" id="content"></textarea></td>
			</tr>

			<tr>
				<td class="table-light">검색어 설정</td>
				<td><textarea placeholder="문구 입력..." class="border-0" rows="2" style="width: 100%;" name="content" id="content"></textarea></td>
			</tr>
		</tbody>
	</table>
			...
			<table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
				<thead>
					<tr>
						<th style="border-right: none;" colspan="2">판매 정보</th>
					</tr>
				</thead>

				<tbody>
					<tr>
						<td class="table-light">소비자가(보류)</td>
						<td>
							<table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
								<thead>
									<tr>
					...
					<tr>
						...
						<td>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"> <label class="form-check-label" for="inlineRadio1">과세상품</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> <label class="form-check-label" for="inlineRadio2">영세상품</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> <label class="form-check-label" for="inlineRadio2">면세상품</label>
							</div>
							<div class="d-flex align-items-center">
							...
							<table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
								<thead>
									...
									<tr>
										...
										<td>
											<button type="submit" class="btn btn-dark" style="border-radius: 1">판매가적용</button>
										</td>
									</tr>
								</thead>
							</table>
					...
					<tr>
						...
						<td>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1"> <label class="form-check-label" for="inlineRadio1">제한안함</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2"> <label class="form-check-label" for="inlineRadio2">단독구매 불가</label>
							</div>
						</td>
					</tr>

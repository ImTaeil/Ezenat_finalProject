...
<div class="container">
	<p style="font-weight: bold; font-size: 30px;'">상품 삭제 목록</p>
	...
	<div>
		<p style="font-weight: bold; font-size: 15px;'">삭제상품목록</p>
		[총 n개]
			...
			<thead>
				...
				<tr>
					<td colspan="9" align="left">
						<button type="submit" class="btn btn-dark" style="border-radius: 1; float: left; margin-right: 5px;">상품복구</button>
						<button type="submit" class="btn btn-dark" style="border-radius: 1; float: left; margin-right: 5px;">완전삭제</button>
					</td>
				</tr>
			</thead>
			<tbody>
